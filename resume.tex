...
\usepackage{fancyhdr}
\pagestyle{fancy}
\chead{\textls[200]{\normalsize \textsc{Simon Niklaus} $\cdot$ \textsc{Computer Vision and Deep Learning} \linebreak \footnotesize \textsc{sniklaus.com} $\cdot$ \textsc{mail@sniklaus.com} $\cdot$ \textsc{github.com/sniklaus}}}
