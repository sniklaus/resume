...
\usepackage[left=3.0cm, right=3.0cm, top=3.0cm, bottom=1.0cm, paperheight=76.0cm]{geometry} % custom page height
...
\usepackage{fancyhdr}
\pagestyle{fancy}
\chead{\textls[200]{\normalsize \textsc{Simon Niklaus} $\cdot$ \textsc{Computer Vision and Deep Learning} \linebreak \footnotesize \textsc{sniklaus.com} $\cdot$ \textsc{mail@sniklaus.com} $\cdot$ \textsc{March, 2025}}}
